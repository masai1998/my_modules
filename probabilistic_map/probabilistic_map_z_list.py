...
class probabilistic_map(object):
    ...
    def __init__(self, raw_data_dir, ciftify_data_dir, contrast_list, task, z_threshold_list, header):
        self.raw_data_dir = raw_data_dir
        self.ciftify_data_dir = ciftify_data_dir
        self.contrast_list = contrast_list
        self.task = task
        self.z_threshold_list = z_threshold_list
        self.header = header
    ...
    def generate_map(self):
        ...
        for z_threshold in self.z_threshold_list:
            ...
            for subject in subject_list:
                ...
                for session in session_list:
                    ...
                    for contrast_name in contrast_dict.keys():
                        ...
                        current_data_threshold = np.where(current_data > z_threshold, 1, 0)
            ...
            for contrast_name in contrast_dict.keys():
                ...
                save_path = os.path.join(probabilistic_map_dir, contrast_name + '_' + 'z=' + str(z_threshold) + '.dscalar.nii')
